 ...
 * like import Typography from '@pointfree/core/Typography' are tree-shakeable.
 *
...
async function run() {
  try {
    ...
    await Promise.all(
      [
        // use enhanced readme from workspace root for `@pointfree/core`
        packageData.name === '@pointfree/core' ? '../../README.md' : './README.md',
        // '../../CHANGELOG.md',
        '../../LICENSE',
